...
const AddPauta: React.FC<PautaProps> = ({
  ...
  async function handleCreateNewPauta({
    ...
    try {
      ...
      const result = await api.post("/pautaExameCreate", {
        nota1,
        nota2,
        notaExame,
        mediaFinal:
      ...
      setLoading(false);
      Swal.fire("Pauta Exame!", "Nota adicionada com sucesso", "success");
                      ...
                      <CFormGroup row>
                        ...
                        <CCol xs="12" md="6">
                          ...
                          <CInput
                            ...
                            value={values.notaExame}
                            onBlur={handleBlur("notaExame")}
                            onChange={handleChange("notaExame")}
                            className={
                              errors.notaExame ? "input-error" : "none"
                            }
                          />
                          {errors.notaExame ? (
                            <div className="errors">
